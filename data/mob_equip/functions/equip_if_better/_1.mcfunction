...
execute unless data storage mob_equip:equip_if_better root.in.ignore_slots{feet:1b} if items entity @s weapon.mainhand #mob_equip:armor/type/boots run scoreboard players set #_slot meq._ 1
execute unless data storage mob_equip:equip_if_better root.in.ignore_slots{legs:1b} if items entity @s weapon.mainhand #mob_equip:armor/type/leggings run scoreboard players set #_slot meq._ 2
execute unless data storage mob_equip:equip_if_better root.in.ignore_slots{chest:1b} if items entity @s weapon.mainhand #mob_equip:armor/type/chestplate run scoreboard players set #_slot meq._ 3
execute unless data storage mob_equip:equip_if_better root.in.ignore_slots{head:1b} if items entity @s weapon.mainhand #mob_equip:armor/type/helmet run scoreboard players set #_slot meq._ 4
