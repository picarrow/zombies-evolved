...
function mob_equip:util/equip_if_better/eval
...
function mob_equip:util/equip_if_better/check_if_better
execute if score #_is_better meq._ matches 0 if score #_slot meq._ matches 1..4 unless data storage mob_equip:equip_if_better root.in.ignore_slots{mainhand:1b} run function mob_equip:util/equip_if_better/try_main_hand
execute if score #_is_better meq._ matches 1 run function mob_equip:util/equip_if_better/equip
