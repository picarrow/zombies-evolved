...
execute if score $is_event picarrow.hardcore_zombies.variable matches 1 unless score $event_began picarrow.hardcore_zombies.variable matches 1 run function picarrow.hardcore_zombies:_private/event/begin
execute if score $event_began picarrow.hardcore_zombies.variable matches 1 run function picarrow.hardcore_zombies:_private/event/tick
