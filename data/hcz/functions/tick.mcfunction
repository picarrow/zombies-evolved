...
execute as @e[tag=hcz.swarmer,tag=!hcz.specialized] at @s run function hcz:swarmer/assign_class
...
execute as @e[tag=hcz.swarmer] at @s run function hcz:swarmer/tick
