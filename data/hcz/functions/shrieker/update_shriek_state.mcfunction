...
execute if score @s hcz.shrieker_shriek_timer matches 45 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 40 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 35 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 30 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 25 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 20 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 15 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 10 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 5 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
execute if score @s hcz.shrieker_shriek_timer matches 0 run particle minecraft:shriek 0 ~ ~1.75 ~ 0 0 0 1 1 normal
