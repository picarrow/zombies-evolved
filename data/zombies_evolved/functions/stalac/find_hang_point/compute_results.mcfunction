...
execute at @s if block ~ ~ ~ #zombies_evolved:stalac_base unless entity @e[dy=-1,type=#zombies_evolved:targets,tag=zev.stalac.hanging] run data merge storage zombies_evolved:find_hang_point {Valid:1b}
