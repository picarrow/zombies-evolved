...
execute if score $out rdm._ <= #_high_bound zev._ if score #_jacky_can_spawn zev._ matches 1 store success score #_is_special zev._ run tag @s add zev.jacky
...
execute if score $out rdm._ >= #_low_bound zev._ if score $out rdm._ <= #_high_bound zev._ if score #_shrieker_can_spawn zev._ matches 1 store success score #_is_special zev._ run tag @s add zev.shrieker
...
execute if score $out rdm._ >= #_low_bound zev._ if score $out rdm._ <= #_high_bound zev._ if score #_stalac_can_spawn zev._ matches 1 store success score #_is_special zev._ run tag @s add zev.stalac
