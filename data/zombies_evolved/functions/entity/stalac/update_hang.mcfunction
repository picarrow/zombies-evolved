...
execute if score @s zev.stalac.phase_time matches 4 unless predicate zombies_evolved:is_baby unless block ~ ~2 ~ #zombies_evolved:stalac_hangable run function zombies_evolved:entity/stalac/fall
execute if score @s zev.stalac.phase_time matches 4 if predicate zombies_evolved:is_baby unless block ~ ~1 ~ #zombies_evolved:stalac_hangable run function zombies_evolved:entity/stalac/fall
