...
# Determine dx and dz
execute store result score #_max zev._ if data storage zombies_evolved:_ _.func.crumble.temp.positions[]
execute store result storage zombies_evolved:_ _.func.crumble.temp.max int 1 run scoreboard players remove #_max zev._ 1
...
execute if score #_attempts zev._ < #_max_attempts zev._ if score #_guiders zev._ < #_max_guiders zev._ if data storage zombies_evolved:_ _.func.crumble.temp.positions[] run function zombies_evolved:entity/crumble_guider/spawn_set/_1
