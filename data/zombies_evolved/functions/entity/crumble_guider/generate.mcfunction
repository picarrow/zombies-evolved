...
execute if score @s zev.crumble_guider.age matches 1 run particle minecraft:block{block_state:{Name:"minecraft:dripstone_block"}} ~ ~-0.05 ~ 0.2 0 0.2 1 50 normal
