...
# Give the new item to the armor stand for evaluation
data modify entity @s HandItems[0] set from storage zombies_evolved:equip_if_better item

# Determine the slot the new item corresponds to
