...
execute if score #_slot zev._ matches 0 run data modify storage zombies_evolved:equip_if_better out.item set from storage zombies_evolved:_temp root.zombie.HandItems[0]
execute if score #_slot zev._ matches 1 run data modify storage zombies_evolved:equip_if_better out.item set from storage zombies_evolved:_temp root.zombie.ArmorItems[0]
execute if score #_slot zev._ matches 2 run data modify storage zombies_evolved:equip_if_better out.item set from storage zombies_evolved:_temp root.zombie.ArmorItems[1]
execute if score #_slot zev._ matches 3 run data modify storage zombies_evolved:equip_if_better out.item set from storage zombies_evolved:_temp root.zombie.ArmorItems[2]
execute if score #_slot zev._ matches 4 run data modify storage zombies_evolved:equip_if_better out.item set from storage zombies_evolved:_temp root.zombie.ArmorItems[3]
