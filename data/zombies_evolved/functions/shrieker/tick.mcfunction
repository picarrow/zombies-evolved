...
execute if entity @s[tag=zev.shrieker.enraged] unless entity @e[type=minecraft:warden,distance=..24] if data entity @s {OnGround:1b} run function zombies_evolved:shrieker/erupt_warden
