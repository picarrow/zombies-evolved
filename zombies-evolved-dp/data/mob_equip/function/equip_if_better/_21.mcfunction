...
# ...
execute if function mob_equip:equip_if_better/is_better/_ run return run function mob_equip:equip_if_better/_213 with storage mob_equip:data _.func.equip_if_better.temp
