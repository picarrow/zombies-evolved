...
function mob_equip:equip_if_better/_221 with storage mob_equip:data _.func.equip_if_better.temp.equip_args

# Set the slot with the new item to always drop
data modify entity @s drop_chances.mainhand set value 2f
