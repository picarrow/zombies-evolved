...
data modify storage mob_equip:data _.func.equip_if_better.temp.item_to_eval set from storage mob_equip:data _.func.equip_if_better.temp.entity.equipment.mainhand
