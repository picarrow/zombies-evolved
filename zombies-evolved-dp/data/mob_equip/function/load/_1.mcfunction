...
# ...
data modify storage mob_equip:data _.func.equip_if_better.lookup.alias_by_equip_slot set value { \
...
data modify storage mob_equip:data _.func.equip_if_better.lookup.default_equip_slot_by_item set value { \
...
# ...
data modify storage mob_equip:data _.func.equip_if_better.common.tier_by_mainhand_item set value { \
...
data modify storage mob_equip:data _.func.equip_if_better.common.tier_by_offhand_item set value { \
  "minecraft:shield": 2b                                                                          \
}
data modify storage mob_equip:data _.func.equip_if_better.common.tier_by_head_item set value { \
...
data modify storage mob_equip:data _.func.equip_if_better.common.tier_by_chest_item set value { \
...
data modify storage mob_equip:data _.func.equip_if_better.common.tier_by_legs_item set value { \
...
data modify storage mob_equip:data _.func.equip_if_better.common.tier_by_feet_item set value { \
