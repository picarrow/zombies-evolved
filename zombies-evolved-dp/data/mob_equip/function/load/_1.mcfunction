...
data modify storage mob_equip:data _.func.equip_if_better.common.tool_tier_map set value { \
  "minecraft:wooden_axe": 14b, \
  "minecraft:golden_axe": 14b, \
  "minecraft:stone_axe": 15b, \
  "minecraft:iron_axe": 15b, \
  "minecraft:diamond_axe": 15b, \
  "minecraft:netherite_axe": 16b, \
  \
  ...
  "minecraft:golden_sword": 18b, \
  "minecraft:stone_sword": 19b, \
  "minecraft:iron_sword": 20b, \
  "minecraft:diamond_sword": 21b, \
  "minecraft:netherite_sword": 22b, \
  \
  "minecraft:trident": 13b \
}
