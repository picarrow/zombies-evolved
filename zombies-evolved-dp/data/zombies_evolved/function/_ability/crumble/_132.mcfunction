...
execute if score #_dy zev._ matches 0.. if block ~ ~ ~ #zombies_evolved:crumbling_stalactite_can_originate_from align xyz positioned ~0.5 ~ ~0.5 run return run function zombies_evolved:_ability/crumble/_1321
