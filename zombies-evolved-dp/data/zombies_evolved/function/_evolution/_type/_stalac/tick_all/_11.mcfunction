...
execute if score @s zev.stalac.phase_time matches 2 positioned ~-3 ~-31 ~-3 if entity @e[dx=5,dy=31,dz=5,type=minecraft:player,gamemode=!creative,gamemode=!spectator,limit=1] positioned as @s run function zombies_evolved:_evolution/_type/_stalac/tick_all/ambush/_
execute if score @s zev.stalac.phase_time matches 2 positioned ~-3 ~-31 ~-3 if entity @e[dx=5,dy=31,dz=5,type=minecraft:villager,limit=1] positioned as @s run function zombies_evolved:_evolution/_type/_stalac/tick_all/ambush/_
