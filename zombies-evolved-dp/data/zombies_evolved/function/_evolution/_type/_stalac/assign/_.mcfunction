...
data modify storage zombies_evolved:data _.func."evolution.stalac.assign".temp.entity_data.equipment.head set value {id:"minecraft:dripstone_block"}
data modify storage zombies_evolved:data _.func."evolution.stalac.assign".temp.entity_data.drop_chances.head set value 0f
