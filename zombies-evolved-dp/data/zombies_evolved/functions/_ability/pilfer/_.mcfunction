...
execute if data storage zombies_evolved:pilfer temp.stolen_item run function zombies_evolved:_ability/pilfer/_2

# Drops an item, if there is an extra
execute if data storage zombies_evolved:pilfer temp.item_to_drop on attacker at @s run function zombies_evolved:_ability/pilfer/_3
